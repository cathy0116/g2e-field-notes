const VERSION='public-v2.3.0', SHELL='g2e-shell-'+VERSION, FULL='g2e-offline-'+VERSION;
const CORE=['./','index.html','styles.css','app.js','audio.js','ui.js','lifecycle.js','help.js','model.js','ekg.js','db.js','manifest.webmanifest','icon.svg','icon-192.png','icon-512.png','apple-touch-icon.png','offline-assets.json'];
